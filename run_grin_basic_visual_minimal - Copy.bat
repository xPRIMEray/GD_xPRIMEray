...
echo ========================================
echo GRIN Basic Visual Curved Minimal Test
echo fixture=grin_basic_visual_minimal
...
set "SCENE_PATH=res://test-grin-basic-visual-minimal.tscn"
set "XPRIMERAY_REQUESTED_LAUNCHER=run_grin_basic_visual_minimal"
