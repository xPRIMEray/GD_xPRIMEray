...
FIXTURE_ID="fixture_010_wormhole_witness_exit"
SCENE_PATH="res://test-overspace-wormhole-witness-exit-fixture.tscn"
LAUNCHER_TOKEN="run_fixture_010_wormhole_witness_exit"
SETTLE_FRAMES="${FIXTURE_010_EXIT_SETTLE_FRAMES:-12}"
MIN_RH_STEP="${FIXTURE_010_EXIT_MIN_RH_STEP:-1}"
MIN_PROCESSED_ROWS="${FIXTURE_010_EXIT_MIN_PROCESSED_ROWS:-270}"
CAPTURE_FILM_OPACITY="${FIXTURE_010_EXIT_CAPTURE_FILM_OPACITY:-1.0}"
COMPARE_GRID="${FIXTURE_010_EXIT_COMPARE_GRID:-0}"
COMPARE_CROSSHAIR="${FIXTURE_010_EXIT_COMPARE_CROSSHAIR:-0}"
VISUAL_MODE="${FIXTURE_010_EXIT_VISUAL_MODE:-geometry_context}"
ANALYSIS_CAPTURE_MODE="${FIXTURE_010_EXIT_ANALYSIS_CAPTURE_MODE:-resolved_film}"
SOURCE_HIGHLIGHT="${FIXTURE_010_EXIT_SOURCE_HIGHLIGHT:-0}"
REQUESTED_STEP_LENGTH="${FIXTURE_010_EXIT_STEP_LENGTH:-0.05}"
REQUESTED_MIN_STEP_LENGTH="${FIXTURE_010_EXIT_MIN_STEP_LENGTH:-0.02}"
REQUESTED_STEPS_PER_RAY="${FIXTURE_010_EXIT_STEPS_PER_RAY:-640}"
REQUESTED_TURN_THRESHOLD="${FIXTURE_010_EXIT_TURN_THRESHOLD:-2.4}"
REQUESTED_ERROR_TOLERANCE="${FIXTURE_010_EXIT_ERROR_TOLERANCE:-0.010}"
