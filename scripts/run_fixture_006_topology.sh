...
FIXTURE_ID="fixture_006_topology"
SCENE_PATH="res://test-overspace-hermetic-fixture-topology.tscn"
LAUNCHER_TOKEN="run_fixture_006_topology"
SETTLE_FRAMES="${FIXTURE_005_SETTLE_FRAMES:-12}"
MIN_RH_STEP="${FIXTURE_005_MIN_RH_STEP:-1}"
MIN_PROCESSED_ROWS="${FIXTURE_005_MIN_PROCESSED_ROWS:-270}"
CAPTURE_FILM_OPACITY="${FIXTURE_005_CAPTURE_FILM_OPACITY:-1.0}"
COMPARE_GRID="${FIXTURE_005_COMPARE_GRID:-0}"
COMPARE_CROSSHAIR="${FIXTURE_005_COMPARE_CROSSHAIR:-0}"
VISUAL_MODE="${FIXTURE_005_VISUAL_MODE:-geometry_context}"
ANALYSIS_CAPTURE_MODE="${FIXTURE_005_ANALYSIS_CAPTURE_MODE:-transport_classification}"
SOURCE_HIGHLIGHT="${FIXTURE_005_SOURCE_HIGHLIGHT:-0}"
REQUESTED_STEP_LENGTH="${FIXTURE_005_STEP_LENGTH:-0.05}"
REQUESTED_MIN_STEP_LENGTH="${FIXTURE_005_MIN_STEP_LENGTH:-0.02}"
REQUESTED_STEPS_PER_RAY="${FIXTURE_005_STEPS_PER_RAY:-640}"
REQUESTED_TURN_THRESHOLD="${FIXTURE_005_TURN_THRESHOLD:-2.4}"
REQUESTED_ERROR_TOLERANCE="${FIXTURE_005_ERROR_TOLERANCE:-0.010}"
