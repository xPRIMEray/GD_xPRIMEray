...
FIXTURE_ID="fixture_008_wormhole_witness"
SCENE_PATH="res://test-overspace-wormhole-witness-fixture.tscn"
LAUNCHER_TOKEN="run_fixture_008_wormhole_witness"
SETTLE_FRAMES="${FIXTURE_008_SETTLE_FRAMES:-12}"
MIN_RH_STEP="${FIXTURE_008_MIN_RH_STEP:-1}"
MIN_PROCESSED_ROWS="${FIXTURE_008_MIN_PROCESSED_ROWS:-270}"
CAPTURE_FILM_OPACITY="${FIXTURE_008_CAPTURE_FILM_OPACITY:-1.0}"
COMPARE_GRID="${FIXTURE_008_COMPARE_GRID:-0}"
COMPARE_CROSSHAIR="${FIXTURE_008_COMPARE_CROSSHAIR:-0}"
VISUAL_MODE="${FIXTURE_008_VISUAL_MODE:-geometry_context}"
ANALYSIS_CAPTURE_MODE="${FIXTURE_008_ANALYSIS_CAPTURE_MODE:-resolved_film}"
SOURCE_HIGHLIGHT="${FIXTURE_008_SOURCE_HIGHLIGHT:-0}"
REQUESTED_STEP_LENGTH="${FIXTURE_008_STEP_LENGTH:-0.05}"
REQUESTED_MIN_STEP_LENGTH="${FIXTURE_008_MIN_STEP_LENGTH:-0.02}"
REQUESTED_STEPS_PER_RAY="${FIXTURE_008_STEPS_PER_RAY:-640}"
REQUESTED_TURN_THRESHOLD="${FIXTURE_008_TURN_THRESHOLD:-2.4}"
REQUESTED_ERROR_TOLERANCE="${FIXTURE_008_ERROR_TOLERANCE:-0.010}"
