...
cls
echo ========================================
echo Metric Basic Visual Menu
echo mode=FULL_RENDER
echo ========================================
echo 1 - Straight baseline
echo 2 - Metric minimal
echo 3 - Metric stronger
echo 4 - Exit
echo.
...
:minimal
call "%~dp0run_metric_basic_visual_minimal.bat" %*
goto :menu

:metric
call "%~dp0run_metric_basic_visual.bat" %*
goto :menu
