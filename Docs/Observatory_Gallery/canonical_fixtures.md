...
> This document is the authoritative reference for what each Observatory fixture is, what it confirms, and what it does not claim. It is intended for engineers, researchers, and reviewers who need to interpret Observatory diagnostic outputs without misreading partial coverage as complete validation.
