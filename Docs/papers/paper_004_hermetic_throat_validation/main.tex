...
\item run directory: \texttt{output/fixture\_runs/fixture\_005/2026-04-12T23-32-11}
\end{itemize}
...
The evidence base for this draft is the validated \texttt{fixture\_005} run at \texttt{2026-04-12T23-32-11}. Table~\ref{tab:results} summarizes the current metrics.
...
Throat entry & 0 \\
Throat exit & 132 \\
Throat shell transform & 21689 \\
Throat inner absorb & 0 \\
Throat pixels & 33356 \\
Max interaction count & 107 \\
Mean interaction count & 2.335472 \\
\bottomrule
\end{tabular}
\caption{Current validated \texttt{fixture\_005} results.}
\label{tab:results}
\end{table}

The primary figure candidates are:
\begin{itemize}[leftmargin=1.5em]
\item \texttt{capture.png}
\item \texttt{coverage\_annotated.png}
\item \texttt{coverage\_legend.png}
\item \texttt{throat\_depth\_map.png}
\item \texttt{throat\_depth\_annotated.png}
\item \texttt{throat\_depth\_legend.png}
\end{itemize}
