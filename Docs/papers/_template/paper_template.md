...
- Penrose: geometry first, computation second.
- Bandyopadhyay: temporal coherence matters in propagation and measurement.
- Orch OR: observer-facing structure emerges through constrained physical selection, not arbitrary sampling.
-->

## 2. Concept: <Invariant / Experimental Object>
...
<!--
Perspective Alignment Notes
- Penrose: treat focusing and continuity as consequences of geometry.
- Bandyopadhyay: describe the object as stable across repeated deterministic realizations.
- Orch OR: keep the language disciplined; structured outcome selection must remain measurable.
-->
...
- Avoid metaphysical framing here.
- Let method carry the authority.
-->
...
<!--
Perspective Alignment Notes
- The figures should feel like different coordinate views of one structure.
- Avoid treating them as disconnected diagnostics.
- Keep prose evidence-facing.
-->
...
<!--
Perspective Alignment Notes
- Penrose: truth conditions matter.
- Bandyopadhyay: stability must persist across repeated runs.
- Determinism is epistemic structure, not just test hygiene.
-->
...
<!--
Perspective Alignment Notes
- Introduce observer-system coupling carefully and only where measurement supports it.
- Keep interpretation grounded in deterministic structure.
- No mysticism, no marketing.
-->
...
<!--
Perspective Alignment Notes
- Appendix stays operational.
- No interpretive language here.
-->
