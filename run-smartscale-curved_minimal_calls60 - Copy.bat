...
rem README: Runs CURVED_MINIMAL with SmartScale enabled (budget=renderstep_calls, n=60), then parses render health output and prints the AutoCal summary block.

echo ============================================================
echo Running xPRIMEray SmartScale Render Test (CURVED_MINIMAL, CALLS60)
echo ============================================================
...
set "RUN_SUFFIX=smartscale_calls60"
...
echo.
echo Finished SmartScale CURVED_MINIMAL CALLS60 test.
endlocal
goto :eof

:fail
echo.
echo FAILED SmartScale CURVED_MINIMAL CALLS60 test.
endlocal
exit /b 1
