...
CSV: `output/fixture_runs/fixture_011_wormhole_checkpoint_sequence/2026-04-24T18-22-35/00_mouth_hit_diagnostics.csv`
...
- `first_segment_jump`: `{'mean': 26.80078125, 'median': 15.0, 'max': 71.0}`
- `final_distance_jump`: `{'mean': 2.6869332187499997, 'median': 1.5570699999999995, 'max': 7.065346}`
- `first_distance_jump`: `{'mean': 2.6869332187499997, 'median': 1.5570699999999995, 'max': 7.065346}`
