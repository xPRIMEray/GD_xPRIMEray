...
CSV: `output/fixture_runs/fixture_011_wormhole_checkpoint_sequence/2026-04-24T01-44-23_first_hit_baseline_current/00_mouth_hit_diagnostics.csv`
...
- `first_segment_jump`: `{'mean': 26.39453125, 'median': 15.0, 'max': 71.0}`
- `final_distance_jump`: `{'mean': 2.645636203125, 'median': 1.5525000000000002, 'max': 7.065346}`
- `first_distance_jump`: `{'mean': 2.645636203125, 'median': 1.5525000000000002, 'max': 7.065346}`
