...
CSV: `output/fixture_runs/fixture_011_wormhole_checkpoint_sequence/2026-04-23T20-03-13_first_hit_boundary/01_post_throat_backstep_01_hit_diagnostics.csv`
...
- `first_segment_jump`: `{'mean': 11.015625, 'median': 14.0, 'max': 16.0}`
- `final_distance_jump`: `{'mean': 1.1147423554687501, 'median': 1.402069000000001, 'max': 1.5998}`
- `first_distance_jump`: `{'mean': 1.1147423554687501, 'median': 1.402069000000001, 'max': 1.5998}`
