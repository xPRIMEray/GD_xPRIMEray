...
- image: /home/bb/code/godot_xPRIMEray/output/curved_field_validation_ladder/20260509T011059Z/control/steps/step_0.00625/domain_resolver_stress__control_step_0p00625__baseline_prune_off__scheduler-baseline__targetms-1000__stride-1__runid-1.png
- hit_csv: /home/bb/code/godot_xPRIMEray/output/curved_field_validation_ladder/20260509T011059Z/control/steps/step_0.00625/domain_resolver_stress__control_step_0p00625__baseline_prune_off__scheduler-baseline__targetms-1000__stride-1__runid-1.hit_diagnostics.csv
- compare_csv: 
- sample_count: 920
- hit_count: 0
- no_hit_count: 920
...
- hit_rows_with_valid_normal_xyz: 350
- sampled_hit_rows_with_valid_normal_xyz: 0
- normal_x_stats: {'min': 0.0, 'max': 0.0, 'mean': 0.0}
- normal_y_stats: {'min': 0.0, 'max': 0.0, 'mean': 0.0}
- normal_z_stats: {'min': 0.0, 'max': 1.0, 'mean': 0.006076}
- hit_normal_x_stats: {'min': 0.0, 'max': 0.0, 'mean': 0.0}
- hit_normal_y_stats: {'min': 0.0, 'max': 0.0, 'mean': 0.0}
- hit_normal_z_stats: {'min': 1.0, 'max': 1.0, 'mean': 1.0}
- projected_xy_magnitude_histogram: {'[0,1e-6)': 57250, '[1e-6,1e-4)': 0, '[1e-4,1e-3)': 0, '[1e-3,1e-2)': 0, '[1e-2,1e-1)': 0, '[1e-1,0.5)': 0, '[0.5,1.0]': 350, '>1.0': 0}
- hit_projected_xy_magnitude_histogram: {'[0,1e-6)': 0, '[1e-6,1e-4)': 0, '[1e-4,1e-3)': 0, '[1e-3,1e-2)': 0, '[1e-2,1e-1)': 0, '[1e-1,0.5)': 0, '[0.5,1.0]': 350, '>1.0': 0}
