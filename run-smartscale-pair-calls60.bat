...
rem README: Runs STRAIGHT then CURVED_MINIMAL with SmartScale (budget=renderstep_calls, n=60), parses each log, and prints AutoCal summary blocks.

echo ============================================================
echo Running xPRIMEray SmartScale Render Test Pair (CALLS60)
echo ============================================================
...
echo.
echo Finished SmartScale paired render tests (CALLS60).
endlocal
goto :eof

:fail
echo.
echo FAILED SmartScale paired render tests (CALLS60).
endlocal
exit /b 1
