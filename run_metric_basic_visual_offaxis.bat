...
echo ========================================
echo Metric Basic Visual Curved Stronger Off-Axis Test
echo fixture=metric_basic_visual_offaxis
...
set "SCENE_PATH=res://test-metric-basic-visual-offaxis.tscn"
set "XPRIMERAY_REQUESTED_LAUNCHER=run_metric_basic_visual_offaxis"
