...
echo ========================================
echo GRIN Basic Visual Curved Stronger Off-Axis Test
echo fixture=grin_basic_visual_offaxis
...
set "SCENE_PATH=res://test-grin-basic-visual-offaxis.tscn"
set "XPRIMERAY_REQUESTED_LAUNCHER=run_grin_basic_visual_offaxis"
