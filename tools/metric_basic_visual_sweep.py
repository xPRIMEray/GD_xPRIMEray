...
CASES = [
    ...
    },
    {
        "id": "minimal_baseline",
        "rung": "minimal",
        "scene": "res://test-metric-basic-visual-minimal.tscn",
        "launcher": "run_metric_basic_visual_minimal",
        "overrides": {},
    },
    {
        "id": "stronger_baseline",
        "rung": "stronger",
        "scene": "res://test-metric-basic-visual.tscn",
        "launcher": "run_metric_basic_visual",
        "overrides": {},
    },
    {
        "id": "minimal_amp_0p75",
    ...
    {
        "id": "minimal_router_4p5",
        "rung": "minimal",
        "scene": "res://test-metric-basic-visual-minimal.tscn",
        "launcher": "run_metric_basic_visual_minimal",
        "overrides": {"r_outer": 4.5},
    },
    {
        "id": "minimal_router_5p5",
        "rung": "minimal",
        "scene": "res://test-metric-basic-visual-minimal.tscn",
        "launcher": "run_metric_basic_visual_minimal",
        "overrides": {"r_outer": 5.5},
    },
    {
        "id": "minimal_gamma_1p4",
        "rung": "minimal",
        "scene": "res://test-metric-basic-visual-minimal.tscn",
        "launcher": "run_metric_basic_visual_minimal",
        "overrides": {"gamma": 1.4},
    ...
    {
        "id": "stronger_router_7p5",
        "rung": "stronger",
        "scene": "res://test-metric-basic-visual.tscn",
        "launcher": "run_metric_basic_visual",
        "overrides": {"r_outer": 7.5},
    },
    {
        "id": "stronger_gamma_2p0",
        "rung": "stronger",
        "scene": "res://test-metric-basic-visual.tscn",
        "launcher": "run_metric_basic_visual",
        "overrides": {"gamma": 2.0},
...
def build_case_args(case: dict, screenshot_path: Path) -> list[str]:
    settle_frames = int(
        os.environ.get(
            "METRIC_BASIC_SWEEP_SETTLE_FRAMES",
            os.environ.get("GRIN_BASIC_SWEEP_SETTLE_FRAMES", str(DEFAULT_SETTLE_FRAMES)),
        )
    )
    min_rh_step = int(
        os.environ.get(
            "METRIC_BASIC_SWEEP_MIN_RH_STEP",
            os.environ.get("GRIN_BASIC_SWEEP_MIN_RH_STEP", str(DEFAULT_MIN_RENDER_HEALTH_STEP)),
        )
    )
    min_processed_rows = int(
        os.environ.get(
            "METRIC_BASIC_SWEEP_MIN_PROCESSED_ROWS",
            os.environ.get("GRIN_BASIC_SWEEP_MIN_PROCESSED_ROWS", str(DEFAULT_MIN_PROCESSED_ROWS)),
        )
    )
    capture_film_opacity = float(
        os.environ.get(
            "METRIC_BASIC_SWEEP_CAPTURE_FILM_OPACITY",
            os.environ.get("GRIN_BASIC_SWEEP_CAPTURE_FILM_OPACITY", str(DEFAULT_CAPTURE_FILM_OPACITY)),
        )
    )
    args = [
