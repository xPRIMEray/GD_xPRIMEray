...
echo ========================================
echo Metric Basic Visual Curved Minimal Test
echo fixture=metric_basic_visual_minimal
...
set "SCENE_PATH=res://test-metric-basic-visual-minimal.tscn"
set "XPRIMERAY_REQUESTED_LAUNCHER=run_metric_basic_visual_minimal"
