...
echo ========================================
echo GRIN Basic Visual Straight Off-Axis Test
echo fixture=grin_basic_visual_straight_offaxis
...
set "SCENE_PATH=res://test-grin-basic-visual-straight-offaxis.tscn"
set "XPRIMERAY_REQUESTED_LAUNCHER=run_grin_basic_visual_straight_offaxis"
