...
- Traversal budget stress: 31.5% of pixels exhausted step budget; all found hit on overrun step (budget+1); budget_exhausted_without_hit = 0
...
- Artifact families that changed with curvature: `budget_heatmap, budget_overlay, cartesian_wireframe_overlay, combined_diagnostic_overlay, curvature_field_view, curved_vs_straight_difference, diagnostic_contact_sheet, geometry_explanation, hit_miss_map, normal_overlay, ownership_seams, raw_visual, screenshot, transport_continuity, transport_ownership, traversal_step_heatmap`
...
- Raw output root: `/home/bb/code/godot_xPRIMEray/output/curvature_fps_benchmark/20260607T152708Z`
