...
echo ========================================
echo Metric Basic Visual Curved Stronger Test
echo fixture=metric_basic_visual
...
set "SCENE_PATH=res://test-metric-basic-visual.tscn"
set "XPRIMERAY_REQUESTED_LAUNCHER=run_metric_basic_visual"
